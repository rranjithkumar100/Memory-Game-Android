package com.agileinfoways.memorygame.game.engine;
...
import com.agileinfoways.memorygame.game.events.EventObserverAdapter;
...
import com.agileinfoways.memorygame.game.model.BoardArrangment;
import com.agileinfoways.memorygame.game.model.BoardConfiguration;
		...
		if (drawable != null) {
			...
			new AsyncTask<Void, Void, Bitmap>() {
				...
				protected Bitmap doInBackground(Void... params) {
					Bitmap bitmap = Utils.scaleDown(R.drawable.category_bg, Utils.screenWidth(), Utils.screenHeight());
					return bitmap;
				}
